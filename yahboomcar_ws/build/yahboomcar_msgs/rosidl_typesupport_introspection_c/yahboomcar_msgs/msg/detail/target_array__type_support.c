...
size_t yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__size_function__TargetArray__data(
...
const void * yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__get_const_function__TargetArray__data(
...
void * yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__get_function__TargetArray__data(
...
void yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__fetch_function__TargetArray__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const yahboomcar_msgs__msg__Target * item =
    ((const yahboomcar_msgs__msg__Target *)
    yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__get_const_function__TargetArray__data(untyped_member, index));
  yahboomcar_msgs__msg__Target * value =
    (yahboomcar_msgs__msg__Target *)(untyped_value);
  *value = *item;
}

void yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__assign_function__TargetArray__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  yahboomcar_msgs__msg__Target * item =
    ((yahboomcar_msgs__msg__Target *)
    yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__get_function__TargetArray__data(untyped_member, index));
  const yahboomcar_msgs__msg__Target * value =
    (const yahboomcar_msgs__msg__Target *)(untyped_value);
  *item = *value;
}

bool yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__resize_function__TargetArray__data(
...
static rosidl_typesupport_introspection_c__MessageMember yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__TargetArray_message_member_array[1] = {
  {
    ...
    NULL,  // default value
    yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__size_function__TargetArray__data,  // size() function pointer
    yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__get_const_function__TargetArray__data,  // get_const(index) function pointer
    yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__get_function__TargetArray__data,  // get(index) function pointer
    yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__fetch_function__TargetArray__data,  // fetch(index, &value) function pointer
    yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__assign_function__TargetArray__data,  // assign(index, value) function pointer
    yahboomcar_msgs__msg__TargetArray__rosidl_typesupport_introspection_c__resize_function__TargetArray__data  // resize(index) function pointer
  }
};
