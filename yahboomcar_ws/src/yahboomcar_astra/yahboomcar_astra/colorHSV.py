...
class Color_Identify(Node):
    def __init__(self,name):
        ...
        self.Mouse_XY = (0, 0)
        self.declare_param()
        self.hsv_text = "/home/jetson/yahboomcar_ros2_ws/yahboomcar_ws/src/yahboomcar_astra/yahboomcar_astra/colorHSV.text"
    ...
    def on_timer(self):
        ...
        frame, binary = self.process(self.current_frame.copy(), action)
        self.end = time.time()
