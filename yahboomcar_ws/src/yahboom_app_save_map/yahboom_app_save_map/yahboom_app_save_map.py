...
class MinimalService(Node):
    ...
    def add_three_ints_callback(self, request, response):
        ...
        map_path = "/home/jetson/yahboomcar_ros2_ws/yahboomcar_ws/src/yahboomcar_nav/maps/" + map_name
        ...
        try:
            conn = sqlite3.connect("/home/jetson/yahboomcar_ros2_ws/yahboomcar_ws/src/yahboom_app_save_map/yahboom_app_save_map/xgo.db")
            c = conn.cursor()
            c.execute("INSERT INTO xgo_map (map_name, map_id, map_path) VALUES (?, ?, ?)",(map_name, map_id, map_path))
            self.run_shellcommand('ros2', 'run', 'nav2_map_server', 'map_saver_cli','-f', map_path, '--ros-args', '-p', 'save_map_timeout:=10000.0')
