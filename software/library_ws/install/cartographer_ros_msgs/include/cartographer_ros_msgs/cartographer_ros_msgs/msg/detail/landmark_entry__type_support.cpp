...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LandmarkEntry_message_member_array[5] = {
  {
    "id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cartographer_ros_msgs::msg::LandmarkEntry, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
