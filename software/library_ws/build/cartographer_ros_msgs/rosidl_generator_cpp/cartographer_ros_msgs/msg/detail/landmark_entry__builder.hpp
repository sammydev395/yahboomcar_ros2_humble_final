...
class Init_LandmarkEntry_type
{
public:
  explicit Init_LandmarkEntry_type(::cartographer_ros_msgs::msg::LandmarkEntry & msg)
  : msg_(msg)
  {}
  Init_LandmarkEntry_tracking_from_landmark_transform type(::cartographer_ros_msgs::msg::LandmarkEntry::_type_type arg)
  {
...
public:
  ...
  {}
  Init_LandmarkEntry_type id(::cartographer_ros_msgs::msg::LandmarkEntry::_id_type arg)
  {
    msg_.id = std::move(arg);
    return Init_LandmarkEntry_type(msg_);
  }
